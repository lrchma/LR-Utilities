# #######################################################################################################
# LogRhythm Minimal Viable Solution (MVS) Designer
# Chris Martin
# 21 July 2017
# 
# 
...
<Data>
    ...
    <PreparedBy>LogRhythm MVS Designer</PreparedBy>
    <DateCreated>{1}</DateCreated>
    <SustainedMPSRate>{2}</SustainedMPSRate>
    <LicenseRate>{3}</LicenseRate>
    <PeakMPSRate>{4}</PeakMPSRate>
</Data>
" -f $ProspectName, (get-Date -format r), $variables.Item("Messages Per Second"), [int]$model.License_Rate, ( $variables.Item("Messages Per Second") * 1.5 )
